...
#SBATCH --job-name=render_scenes_dist_3200_3250
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_scenes_dist_3200_3250.out
#SBATCH --error=myjob.render_scenes_dist_3200_3250.err
# =============================================================================
# Multi-worker distributed rendering: scenes 3200-3250 with 4 workers per GPU
# Submit: cd /projects/vig/yiwenc/ResearchProjects/lightingDiffusion/3dgs/render_objaverse && \
#   sbatch scripts/distribute_render_3dscenes_200_250.sh
