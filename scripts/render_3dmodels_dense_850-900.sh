...
#SBATCH --ntasks=8
#SBATCH --gres=gpu:1
#SBATCH --output=myjob.render_objaverse_3350-3400.out
#SBATCH --error=myjob.render_objaverse_3350-3400.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 550 --end_uid 600
python render_3dmodels_dense.py --group_start 3350 --group_end 3400 \
