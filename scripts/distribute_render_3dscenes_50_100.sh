...
#SBATCH --nodes=1
#SBATCH --time=8:00:00
#SBATCH --job-name=render_scenes_dist_3050_3100
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:h200:1
#SBATCH --output=myjob.render_scenes_dist_3050_3100.out
#SBATCH --error=myjob.render_scenes_dist_3050_3100.err
# =============================================================================
# Multi-worker distributed rendering: scenes 50-100 with 4 workers per GPU
