...
#SBATCH --job-name=render_objaverse_test_split_0_8
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_test_split_0_8.out
#SBATCH --error=myjob.render_objaverse_test_split_0_8.err
