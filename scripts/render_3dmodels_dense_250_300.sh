...
#SBATCH --job-name=render_objaverse_7450_7500
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_7450_7500.out
#SBATCH --error=myjob.render_objaverse_7450_7500.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 250 --end_uid 300
python render_3dmodels_dense.py --group_start 7450 --group_end 7500 \
