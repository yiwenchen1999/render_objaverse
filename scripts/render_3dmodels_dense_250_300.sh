...
#SBATCH --job-name=render_objaverse_addLights_6250_6300
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_addLights_6250_6300.out
#SBATCH --error=myjob.render_objaverse_addLights_6250_6300.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 250 --end_uid 300
python render_3dmodels_dense_addLights.py --group_start 6250 --group_end 6300 \
