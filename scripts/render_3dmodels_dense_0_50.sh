...
#SBATCH --job-name=render_objaverse_8800_8850
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_8800_8850.out
#SBATCH --error=myjob.render_objaverse_8800_8850.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 0 --end_uid 50
python render_3dmodels_dense.py --group_start 8800 --group_end 8850 \
