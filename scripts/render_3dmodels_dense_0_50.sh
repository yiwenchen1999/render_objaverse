...
#SBATCH --job-name=render_objaverse_7200_7250
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_7200_7250.out
#SBATCH --error=myjob.render_objaverse_7200_7250.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 0 --end_uid 50
python render_3dmodels_dense.py --group_start 7200 --group_end 7250 \
