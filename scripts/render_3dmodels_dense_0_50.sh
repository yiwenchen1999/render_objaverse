...
#SBATCH --output=myjob.render_objaverse_3500_3550.out
#SBATCH --error=myjob.render_objaverse_3500_3550.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 0 --end_uid 50
python render_3dmodels_dense.py --group_start 3500 --group_end 3550 \
