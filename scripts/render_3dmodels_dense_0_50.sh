...
#SBATCH --job-name=render_objaverse_2500_2550
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_2500_2550.out
#SBATCH --error=myjob.render_objaverse_2500_2550.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 0 --end_uid 50
python render_3dmodels_dense.py --group_start 2500 --group_end 2550 \
