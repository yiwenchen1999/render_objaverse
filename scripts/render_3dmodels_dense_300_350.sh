...
#SBATCH --job-name=render_objaverse_addLights_4300_4350
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_addLights_4300_4350.out
#SBATCH --error=myjob.render_objaverse_addLights_4300_4350.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 300 --end_uid 350
python render_3dmodels_dense_addLights.py --group_start 4300 --group_end 4350 \
