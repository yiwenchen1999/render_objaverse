...
#SBATCH --job-name=render_objaverse_7500_7550
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_7500_7550.out
#SBATCH --error=myjob.render_objaverse_7500_7550.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 300 --end_uid 350
python render_3dmodels_dense.py --group_start 7500 --group_end 7550 \
