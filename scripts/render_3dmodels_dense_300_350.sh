...
#SBATCH --job-name=render_objaverse_5300_5350
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_5300_5350.out
#SBATCH --error=myjob.render_objaverse_5300_5350.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 300 --end_uid 350
python render_3dmodels_dense.py --group_start 5300 --group_end 5350 \
