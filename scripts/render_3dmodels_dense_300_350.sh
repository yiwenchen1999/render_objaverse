...
#SBATCH --job-name=render_objaverse_3800_3850
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_3800_3850.out
#SBATCH --error=myjob.render_objaverse_3800_3850.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 300 --end_uid 350
python render_3dmodels_dense.py --group_start 3800 --group_end 3850 \
