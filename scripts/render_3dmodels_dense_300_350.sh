...
#SBATCH --job-name=render_objaverse_9100_9150
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_9100_9150.out
#SBATCH --error=myjob.render_objaverse_9100_9150.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 300 --end_uid 350
python render_3dmodels_dense.py --group_start 9100 --group_end 9150 \
