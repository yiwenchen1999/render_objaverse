...
#SBATCH --job-name=render_scenes_dist_5000_5050
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_scenes_dist_5000_5050.out
#SBATCH --error=myjob.render_scenes_dist_5000_5050.err
# =============================================================================
# Multi-worker distributed rendering: scenes 5000-5050 with 2 workers per GPU
