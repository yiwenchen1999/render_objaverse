...
#SBATCH --nodes=1
#SBATCH --time=8:00:00
#SBATCH --job-name=render_models_dense_dist_550_600
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:1
#SBATCH --output=myjob.render_models_dense_dist_550_600.out
#SBATCH --error=myjob.render_models_dense_dist_550_600.err
# =============================================================================
# Multi-worker distributed rendering: models 550-600 with 2 workers per GPU
