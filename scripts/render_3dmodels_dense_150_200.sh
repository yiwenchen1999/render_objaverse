...
#SBATCH --job-name=render_objaverse_3650_3700
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_3650_3700.out
#SBATCH --error=myjob.render_objaverse_3650_3700.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 150 --end_uid 200
python render_3dmodels_dense.py --group_start 3650 --group_end 3700 \
