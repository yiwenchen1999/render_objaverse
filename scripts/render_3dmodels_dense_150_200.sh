...
#SBATCH --output=myjob.render_objaverse_2150_2200.out
#SBATCH --error=myjob.render_objaverse_2150_2200.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 150 --end_uid 200
python render_3dmodels_dense.py --group_start 2150 --group_end 2200 \
