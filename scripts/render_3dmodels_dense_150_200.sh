...
#SBATCH --job-name=render_objaverse_9550_9600
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_9550_9600.out
#SBATCH --error=myjob.render_objaverse_9550_9600.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 150 --end_uid 200
python render_3dmodels_dense.py --group_start 9550 --group_end 9600 \
