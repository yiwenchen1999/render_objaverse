...
#SBATCH --job-name=render_models_dense_dist_150_200
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_models_dense_dist_150_200.out
#SBATCH --error=myjob.render_models_dense_dist_150_200.err
# =============================================================================
# Multi-worker distributed rendering: models 150-200 with 2 workers per GPU
