...
#SBATCH --job-name=render_objaverse_addLights_6150_6200
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_addLights_6150_6200.out
#SBATCH --error=myjob.render_objaverse_addLights_6150_6200.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 150 --end_uid 200
python render_3dmodels_dense_addLights.py --group_start 6150 --group_end 6200 \
