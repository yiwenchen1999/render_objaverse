...
#SBATCH --job-name=render_scenes_dist_5100_5150
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_scenes_dist_5100_5150.out
#SBATCH --error=myjob.render_scenes_dist_5100_5150.err
# =============================================================================
# Multi-worker distributed rendering: scenes 5100-5150 with 2 workers per GPU
