...
#SBATCH --nodes=1
#SBATCH --time=8:00:00
#SBATCH --job-name=render_objaverse_600-650
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:1
#SBATCH --output=myjob.render_objaverse_600-650.out
#SBATCH --error=myjob.render_objaverse_600-650.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 600 --end_uid 650
python render_3dmodels_dense.py --group_start 1600 --group_end 1650 \
