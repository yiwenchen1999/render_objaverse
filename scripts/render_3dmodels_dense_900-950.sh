...
#SBATCH --job-name=render_objaverse_5500_5550
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_5500_5550.out
#SBATCH --error=myjob.render_objaverse_5500_5550.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 400 --end_uid 450
python render_3dmodels_dense.py --group_start 5500 --group_end 5550 \
