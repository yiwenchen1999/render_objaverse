...
#SBATCH --job-name=render_objaverse_900-950
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --output=myjob.render_objaverse_900-950.out
#SBATCH --error=myjob.render_objaverse_900-950.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 850 --end_uid 900
python render_3dmodels_dense.py --group_start 1900 --group_end 1950 \
