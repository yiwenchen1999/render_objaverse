...
#SBATCH --nodes=1
#SBATCH --time=8:00:00
#SBATCH --job-name=download_render_lvis_3000_6000
#SBATCH --mem=32
#SBATCH --ntasks=4
#SBATCH --gres=gpu:1
#SBATCH --output=myjob.download_render_lvis_3000_6000.out
#SBATCH --error=myjob.download_render_lvis_3000_6000.err
...
# 步骤 2: 渲染预览图 (索引 3000-6000)
echo "=========================================="
echo "步骤 2: 开始渲染预览图 (索引 3000-6000)"
echo "=========================================="
echo "时间: $(date)"
