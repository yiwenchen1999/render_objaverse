...
#SBATCH --job-name=render_scenes_dist_5050_5100
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_scenes_dist_5050_5100.out
#SBATCH --error=myjob.render_scenes_dist_5050_5100.err
# =============================================================================
# Multi-worker distributed rendering: scenes 5050-5100 with 2 workers per GPU
