...
#SBATCH --job-name=render_models_dense_dist_15800_15900
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_models_dense_dist_15800_15900.out
#SBATCH --error=myjob.render_models_dense_dist_15800_15900.err
# =============================================================================
# Multi-worker distributed rendering: models 15800-15900 with 2 workers per GPU
# Submit: cd /projects/vig/yiwenc/ResearchProjects/lightingDiffusion/3dgs/render_objaverse && \
#   sbatch scripts/render_objs_enhanced/render_objs_enhanced_15800_15900.sh
# =============================================================================
