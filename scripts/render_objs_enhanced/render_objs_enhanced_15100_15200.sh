...
#SBATCH --job-name=render_models_dense_dist_15100_15200
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_models_dense_dist_15100_15200.out
#SBATCH --error=myjob.render_models_dense_dist_15100_15200.err
# =============================================================================
# Multi-worker distributed rendering: models 15100-15200 with 2 workers per GPU
# Submit: cd /projects/vig/yiwenc/ResearchProjects/lightingDiffusion/3dgs/render_objaverse && \
#   sbatch scripts/render_objs_enhanced/render_objs_enhanced_15100_15200.sh
# =============================================================================
