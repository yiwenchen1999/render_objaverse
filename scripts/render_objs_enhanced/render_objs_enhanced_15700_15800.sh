...
#SBATCH --job-name=render_models_dense_dist_15700_15800
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_models_dense_dist_15700_15800.out
#SBATCH --error=myjob.render_models_dense_dist_15700_15800.err
# =============================================================================
# Multi-worker distributed rendering: models 15700-15800 with 2 workers per GPU
# Submit: cd /projects/vig/yiwenc/ResearchProjects/lightingDiffusion/3dgs/render_objaverse && \
#   sbatch scripts/render_objs_enhanced/render_objs_enhanced_15700_15800.sh
# =============================================================================
