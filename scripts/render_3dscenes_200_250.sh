...
#SBATCH --job-name=render_scenes_dist_5200_5250
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_scenes_dist_5200_5250.out
#SBATCH --error=myjob.render_scenes_dist_5200_5250.err
# =============================================================================
# Multi-worker distributed rendering: scenes 5200-5250 with 2 workers per GPU
