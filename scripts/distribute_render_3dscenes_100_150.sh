...
#SBATCH --nodes=1
#SBATCH --time=8:00:00
#SBATCH --job-name=render_scenes_dist_3100_3150
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:h200:1
#SBATCH --output=myjob.render_scenes_dist_3100_3150.out
#SBATCH --error=myjob.render_scenes_dist_3100_3150.err
# =============================================================================
# Multi-worker distributed rendering: scenes 3100-3150 with 4 workers per GPU
# Submit: cd /projects/vig/yiwenc/ResearchProjects/lightingDiffusion/3dgs/render_objaverse && \
#   sbatch scripts/distribute_render_3dscenes_100_150.sh
# =============================================================================
