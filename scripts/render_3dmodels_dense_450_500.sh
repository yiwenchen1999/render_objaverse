...
#SBATCH --job-name=render_objaverse_addLights_6450_6500
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_addLights_6450_6500.out
#SBATCH --error=myjob.render_objaverse_addLights_6450_6500.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 450 --end_uid 500
python render_3dmodels_dense_addLights.py --group_start 6450 --group_end 6500 \
