...
#SBATCH --job-name=render_objaverse_8250_8300
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_8250_8300.out
#SBATCH --error=myjob.render_objaverse_8250_8300.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 450 --end_uid 500
python render_3dmodels_dense.py --group_start 8250 --group_end 8300 \
