...
#SBATCH --output=myjob.render_objaverse_2450_2500.out
#SBATCH --error=myjob.render_objaverse_2450_2500.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 450 --end_uid 500
python render_3dmodels_dense.py --group_start 2450 --group_end 2500 \
