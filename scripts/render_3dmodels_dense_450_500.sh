...
#SBATCH --job-name=render_objaverse_addLights_11650_11700
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_addLights_11650_11700.out
#SBATCH --error=myjob.render_objaverse_addLights_11650_11700.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 450 --end_uid 500
python render_3dmodels_dense_addLights.py --group_start 11650 --group_end 11700 \
