...
#SBATCH --job-name=render_scenes_dist_5150_5200
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_scenes_dist_5150_5200.out
#SBATCH --error=myjob.render_scenes_dist_5150_5200.err
# =============================================================================
# Multi-worker distributed rendering: scenes 5150-5200 with 2 workers per GPU
