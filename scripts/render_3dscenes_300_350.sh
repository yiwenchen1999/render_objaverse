...
#SBATCH --job-name=render_scenes_dist_5300_5350
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_scenes_dist_5300_5350.out
#SBATCH --error=myjob.render_scenes_dist_5300_5350.err
# =============================================================================
# Multi-worker distributed rendering: scenes 5300-5350 with 2 workers per GPU
