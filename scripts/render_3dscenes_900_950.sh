...
#SBATCH --job-name=render_scenes_dist_5900_5950
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_scenes_dist_5900_5950.out
#SBATCH --error=myjob.render_scenes_dist_5900_5950.err
# =============================================================================
# Multi-worker distributed rendering: scenes 5900-5950 with 2 workers per GPU
