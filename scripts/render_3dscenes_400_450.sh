...
#SBATCH --job-name=render_scenes_dist_5400_5450
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_scenes_dist_5400_5450.out
#SBATCH --error=myjob.render_scenes_dist_5400_5450.err
# =============================================================================
# Multi-worker distributed rendering: scenes 5400-5450 with 2 workers per GPU
