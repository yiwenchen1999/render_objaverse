...
#SBATCH --job-name=render_scenes_dist_5350_5400
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_scenes_dist_5350_5400.out
#SBATCH --error=myjob.render_scenes_dist_5350_5400.err
# =============================================================================
# Multi-worker distributed rendering: scenes 5350-5400 with 2 workers per GPU
