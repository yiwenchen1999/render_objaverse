...
#SBATCH --job-name=render_models_addLights_dist_0_50
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_models_addLights_dist_0_50.out
#SBATCH --error=myjob.render_models_addLights_dist_0_50.err
# =============================================================================
