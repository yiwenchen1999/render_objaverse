...
#SBATCH --nodes=1
#SBATCH --time=8:00:00
#SBATCH --job-name=render_scenes_dist_5550_5600
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:1
#SBATCH --output=myjob.render_scenes_dist_5550_5600.out
#SBATCH --error=myjob.render_scenes_dist_5550_5600.err
# =============================================================================
# Multi-worker distributed rendering: scenes 5550-5600 with 2 workers per GPU
