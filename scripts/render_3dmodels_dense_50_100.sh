...
#SBATCH --job-name=render_objaverse_addLights_10100_10200
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_addLights_10100_10200.out
#SBATCH --error=myjob.render_objaverse_addLights_10100_10200.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 50 --end_uid 100
python render_3dmodels_dense_addLights.py --group_start 10100 --group_end 10200 \
