...
#SBATCH --job-name=render_models_dense_dist_50_100
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_models_dense_dist_50_100.out
#SBATCH --error=myjob.render_models_dense_dist_50_100.err
# =============================================================================
# Multi-worker distributed rendering: models 50-100 with 2 workers per GPU
