...
#SBATCH --job-name=render_objaverse_9450_9500
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_9450_9500.out
#SBATCH --error=myjob.render_objaverse_9450_9500.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 50 --end_uid 100
python render_3dmodels_dense.py --group_start 9450 --group_end 9500 \
