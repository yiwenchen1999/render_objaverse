...
#SBATCH --job-name=render_objaverse_2550_2600
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_2550_2600.out
#SBATCH --error=myjob.render_objaverse_2550_2600.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 50 --end_uid 100
python render_3dmodels_dense.py --group_start 2550 --group_end 2600 \
