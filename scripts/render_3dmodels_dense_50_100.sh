...
#SBATCH --job-name=render_objaverse_addLights_4050_4100
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_addLights_4050_4100.out
#SBATCH --error=myjob.render_objaverse_addLights_4050_4100.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 50 --end_uid 100
python render_3dmodels_dense_addLights.py --group_start 4050 --group_end 4100 \
