...
#SBATCH --nodes=1
#SBATCH --time=8:00:00
#SBATCH --job-name=download_render_lvis_1000_3000
#SBATCH --mem=32
#SBATCH --ntasks=4
#SBATCH --gres=gpu:1
#SBATCH --output=myjob.download_render_lvis_1000_3000.out
#SBATCH --error=myjob.download_render_lvis_1000_3000.err
...
# 步骤 2: 渲染预览图 (索引 1000-3000)
echo "=========================================="
echo "步骤 2: 开始渲染预览图 (索引 1000-3000)"
echo "=========================================="
echo "时间: $(date)"
