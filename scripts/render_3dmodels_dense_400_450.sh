...
#SBATCH --job-name=render_objaverse_7000_7050
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_7000_7050.out
#SBATCH --error=myjob.render_objaverse_6100_6150.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 400 --end_uid 450
python render_3dmodels_dense.py --group_start 7000 --group_end 7050 \
