...
#SBATCH --job-name=render_objaverse_9600_9650
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_9600_9650.out
#SBATCH --error=myjob.render_objaverse_9600_9650.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 200 --end_uid 250
python render_3dmodels_dense.py --group_start 9600 --group_end 9650 \
