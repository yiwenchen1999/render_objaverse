...
#SBATCH --job-name=render_objaverse_7400_7450
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_7400_7450.out
#SBATCH --error=myjob.render_objaverse_7400_7450.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 200 --end_uid 250
python render_3dmodels_dense.py --group_start 7400 --group_end 7450 \
