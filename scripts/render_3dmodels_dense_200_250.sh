...
#SBATCH --job-name=render_objaverse_4200_4250
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_4200_4250.out
#SBATCH --error=myjob.render_objaverse_4200_4250.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 200 --end_uid 250
python render_3dmodels_dense.py --group_start 4200 --group_end 4250 \
