...
#SBATCH --job-name=render_models_dense_dist_200_250
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_models_dense_dist_200_250.out
#SBATCH --error=myjob.render_models_dense_dist_200_250.err
# =============================================================================
# Multi-worker distributed rendering: models 200-250 with 2 workers per GPU
