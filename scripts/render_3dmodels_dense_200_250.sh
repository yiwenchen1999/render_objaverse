...
#SBATCH --job-name=render_objaverse_9000_9050
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_9000_9050.out
#SBATCH --error=myjob.render_objaverse_9000_9050.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 200 --end_uid 250
python render_3dmodels_dense.py --group_start 9000 --group_end 9050 \
