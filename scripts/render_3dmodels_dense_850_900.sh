...
#SBATCH --nodes=1
#SBATCH --time=8:00:00
#SBATCH --job-name=render_models_dense_dist_850_900
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:1
#SBATCH --output=myjob.render_models_dense_dist_850_900.out
#SBATCH --error=myjob.render_models_dense_dist_850_900.err
# =============================================================================
# Multi-worker distributed rendering: models 850-900 with 2 workers per GPU
