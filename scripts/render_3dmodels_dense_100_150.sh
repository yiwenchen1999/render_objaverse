...
#SBATCH --job-name=render_models_dense_dist_100_150
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_models_dense_dist_100_150.out
#SBATCH --error=myjob.render_models_dense_dist_100_150.err
# =============================================================================
# Multi-worker distributed rendering: models 100-150 with 2 workers per GPU
