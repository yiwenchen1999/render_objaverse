...
#SBATCH --job-name=render_objaverse_addLights_2200_2300
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_addLights_2200_2300.out
#SBATCH --error=myjob.render_objaverse_addLights_2200_2300.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 100 --end_uid 150
python render_3dmodels_dense_addLights.py --group_start 2200 --group_end 2300 \
