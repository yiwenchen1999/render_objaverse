...
#SBATCH --job-name=render_objaverse_7300_7350
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_7300_7350.out
#SBATCH --error=myjob.render_objaverse_7300_7350.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 100 --end_uid 150
python render_3dmodels_dense.py --group_start 7300 --group_end 7350 \
