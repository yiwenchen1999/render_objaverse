...
#SBATCH --job-name=render_objaverse_4100_4150
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_4100_4150.out
#SBATCH --error=myjob.render_objaverse_4100_4150.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 100 --end_uid 150
python render_3dmodels_dense.py --group_start 4100 --group_end 4150 \
