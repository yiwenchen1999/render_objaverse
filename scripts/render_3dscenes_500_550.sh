...
#SBATCH --nodes=1
#SBATCH --time=8:00:00
#SBATCH --job-name=render_scenes_dist_5500_5550
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:1
#SBATCH --output=myjob.render_scenes_dist_5500_5550.out
#SBATCH --error=myjob.render_scenes_dist_5500_5550.err
# =============================================================================
# Multi-worker distributed rendering: scenes 5500-5550 with 2 workers per GPU
