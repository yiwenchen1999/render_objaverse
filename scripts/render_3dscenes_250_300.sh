...
#SBATCH --job-name=render_scenes_dist_5250_5300
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_scenes_dist_5250_5300.out
#SBATCH --error=myjob.render_scenes_dist_5250_5300.err
# =============================================================================
# Multi-worker distributed rendering: scenes 5250-5300 with 2 workers per GPU
