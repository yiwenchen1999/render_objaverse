...
#SBATCH --job-name=render_objaverse_5550_5600
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_5550_5600.out
#SBATCH --error=myjob.render_objaverse_5550_5600.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 400 --end_uid 450
python render_3dmodels_dense.py --group_start 5550 --group_end 5600 \
