...
#SBATCH --nodes=1
#SBATCH --time=8:00:00
#SBATCH --job-name=render_scenes_dist_3150_3200
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:h200:1
#SBATCH --output=myjob.render_scenes_dist_3150_3200.out
#SBATCH --error=myjob.render_scenes_dist_3150_3200.err
# =============================================================================
# Multi-worker distributed rendering: scenes 3150-3200 with 4 workers per GPU
# Submit: cd /projects/vig/yiwenc/ResearchProjects/lightingDiffusion/3dgs/render_objaverse && \
#   sbatch scripts/distribute_render_3dscenes_150_200.sh
# =============================================================================
