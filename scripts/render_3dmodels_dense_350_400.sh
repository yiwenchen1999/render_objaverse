...
#SBATCH --job-name=render_objaverse_addLights_6350_6400
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_objaverse_addLights_6350_6400.out
#SBATCH --error=myjob.render_objaverse_addLights_6350_6400.err

# python ../download.py --base_path /projects/vig/Datasets --begin_uid 350 --end_uid 400
python render_3dmodels_dense_addLights.py --group_start 6350 --group_end 6400 \
