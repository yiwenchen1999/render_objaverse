...
#SBATCH --nodes=1
#SBATCH --time=8:00:00
#SBATCH --job-name=render_scenes_dist_5700_5750
#SBATCH --mem=32
#SBATCH --ntasks=8
#SBATCH --gres=gpu:a5000:1
#SBATCH --output=myjob.render_scenes_dist_5700_5750.out
#SBATCH --error=myjob.render_scenes_dist_5700_5750.err
# =============================================================================
# Multi-worker distributed rendering: scenes 5700-5750 with 2 workers per GPU
