#!/bin/bash
# 在交互式会话中运行此脚本
# 使用方法: source bash_scripts/Sony_clusters/interactive_finetune_objaverse_intrinsicHeads_predictWhiteEnv.sh
# 或者: bash bash_scripts/Sony_clusters/interactive_finetune_objaverse_intrinsicHeads_predictWhiteEnv.sh
...
export CKPT_DIR="/music-shared-disk/group/ct/yiwen/codes/LVSMExp/ckpt/LVSM_scene_encoder_decoder_wIntrinsicDecoder_whiteEnvAsAlbedo"
export LVSM_CKPT_DIR="/music-shared-disk/group/ct/yiwen/codes/LVSMExp/ckpt/LVSM_scene_encoder_decoder_og"
