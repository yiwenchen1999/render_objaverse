#!/bin/bash
# 在交互式会话中运行此脚本
# 使用方法: source bash_scripts/Sony_clusters/interactive_train_flowmatch_editor_reconLoss.sh
# 或者: bash bash_scripts/Sony_clusters/interactive_train_flowmatch_editor_reconLoss.sh
