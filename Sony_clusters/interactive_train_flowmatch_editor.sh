#!/bin/bash
# 在交互式会话中运行此脚本
# 使用方法: source bash_scripts/Sony_clusters/interactive_train_flowmatch_editor.sh
# 或者: bash bash_scripts/Sony_clusters/interactive_train_flowmatch_editor.sh
...
export CKPT_DIR="/music-shared-disk/group/ct/yiwen/codes/LVSMExp/ckpt/LVSM_flow_match_editor_dense_lr1e4_singleMap"
