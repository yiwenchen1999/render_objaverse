#!/bin/bash
# 在交互式会话中运行此脚本
# 使用方法: source bash_scripts/Sony_clusters/interactive_relight_general_dense_lr1e4_singleMap_unfreezeEncoder.sh
# 或者: bash bash_scripts/Sony_clusters/interactive_relight_general_dense_lr1e4_singleMap_unfreezeEncoder.sh
