#!/bin/bash
# Interactive finetune on lvsmPlus_objaverse (Sony cluster).
# Usage: source bash_scripts/Sony_clusters/interactive_finetune_objaverse.sh
#   or:  bash bash_scripts/Sony_clusters/interactive_finetune_objaverse.sh
