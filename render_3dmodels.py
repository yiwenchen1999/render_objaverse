...
class Options:
    ...
    three_d_model_path: str = '/home/hieu/.objaverse/hf-objaverse-v1/glbs/000-091/d5e7042d18a14127a9971bb493b8c863.glb' # Base path to 3D models
...
def render_core(args: Options):
    ...
    def render_rgb_and_hint(output_path):
        ...
        # for pass_type, pass_name in [('diffuse_color', 'Diffuse Color'),
        #                             ('normal', 'normal'),
        #                             ('glossy_color', 'metallic')]:
