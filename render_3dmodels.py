...
import glob
error_list = ['17df65e439a14342a06107fee9d0ba29']
...
class Options:
    ...
    group_start: int = 0
    group_end: int = 1000  # Group of models to render
...
if __name__ == '__main__':
    dataset_path = '/home/hieu/datasets/objaverse/data/objaverse/hf-objaverse-v1/glbs/'
    ...
    for i in range(args.group_start, args.group_end):
        ...
        if not os.path.exists(os.path.join(dataset_path,'rendered')):
            os.makedirs(os.path.join(dataset_path,'rendered'))
