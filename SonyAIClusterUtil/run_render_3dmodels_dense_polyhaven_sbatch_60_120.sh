...
# =============================================================================
# sharedp: render_3dmodels_dense_polyhaven.py group 60-120 (60 items)
# Submit: cd /music-shared-disk/group/ct/yiwen/codes/render_objaverse && sbatch SonyAIClusterUtil/run_render_3dmodels_dense_polyhaven_sbatch_60_120.sh
# =============================================================================
