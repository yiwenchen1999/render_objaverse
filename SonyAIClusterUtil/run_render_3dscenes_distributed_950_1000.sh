...
#SBATCH --account=ct
#SBATCH --requeue
#SBATCH --job-name=render_scenes_950_1000
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
...
# =============================================================================
# Multi-worker distributed rendering: 3D scenes 950-1000 with 4 workers per GPU
# Submit: cd /music-shared-disk/group/ct/yiwen/codes/render_objaverse && \
#   sbatch SonyAIClusterUtil/run_render_3dscenes_distributed_950_1000.sh
# =============================================================================
